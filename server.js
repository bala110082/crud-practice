...
app.get('/getnextid', (req, res) => {
    const SQL = "SELECT MAX(id) + 1 AS nextId FROM usersdetails";
...
app.post('/handleform', (req, res) => {
    ...
    database.query(SQL_COMMAND, 
        ...
        (err, result) => {
            ...
            database.query("SELECT MAX(id) + 1 AS nextId FROM usersdetails", (err, idResult) => {
                if (err) {
...
app.get('/fetchdata', (req, res) => {
    ...
    const SQL_COMMAND = "SELECT * FROM usersdetails WHERE id = ?";
...
app.delete('/deletedata', (req, res) => {
    ...
    const SQL_COMMAND = "DELETE FROM usersdetails WHERE id = ?";
